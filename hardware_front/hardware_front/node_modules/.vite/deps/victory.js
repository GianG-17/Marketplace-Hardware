...
var VictoryTransition = class extends import_react7.default.Component {
  ...
  static contextType = timer_context_default;
  ...
  render() {
    ...
    const getTransitionProps = this.props.animate?.getTransitions ? this.props.animate.getTransitions : getTransitionPropsFactory(props, this.state, (newState) => this.setState(newState));
    const child = import_react7.default.Children.toArray(props.children)[0];
...
function addEvents(WrappedComponent, options7) {
  ...
  class AddEventsMixin extends WrappedComponent {
    ...
    state = {};
    getEventState = getEventState.bind(this);
    getScopedEvents = getScopedEvents.bind(this);
...
function locale_default(locale3) {
  ...
  function newFormat(specifier, options7) {
    specifier = formatSpecifier(specifier);
    var fill = specifier.fill, align = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero3 = specifier.zero, width = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type = specifier.type;
    if (type === "n") comma = true, type = "g";
    else if (!formatTypes_default[type]) precision === void 0 && (precision = 12), trim = true, type = "g";
    if (zero3 || fill === "0" && align === "=") zero3 = true, fill = "0", align = "=";
    var prefix = (options7 && options7.prefix !== void 0 ? options7.prefix : "") + (symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : ""), suffix = (symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "") + (options7 && options7.suffix !== void 0 ? options7.suffix : "");
...
function getTickFormat(props, scale) {
  ...
  if (!tickFormat2) {
    ...
    const filteredTickFormat = tickFormat2.filter((t, index2) => tickArrayIndices?.includes(index2));
...
function getDomainFromData2(props, axis) {
  ...
  const tickArray = getTickArray(props);
  const tickValues = tickArray && tickArray?.length !== 0 ? tickArray.map((v) => v.value) : void 0;
...
var ClipPath = (props) => import_react23.default.createElement("defs", null, import_react23.default.createElement("clipPath", {
...
var VictoryAreaBase = class _VictoryAreaBase extends import_react35.default.Component {
  ...
  static defaultTransitions = default_transitions_exports.continuousTransitions();
  static defaultPolarTransitions = default_transitions_exports.continuousPolarTransitions();
  static getDomain = domain_exports.getDomainWithZero;
  static getData = data_exports.getData;
...
var getBaseProps2 = (initialProps, fallbackProps22) => {
  ...
  return ticks2.reduce((childProps, tickValue, index2) => {
    ...
    const tickLayout = {
      ...
      transform: getTickTransform(scale[axis]?.(tickValue), globalTransform, isVertical2)
    };
    const gridLayout = {
      edge: gridEdge,
      transform: {
        x: isVertical2 ? -gridOffset.x + globalTransform.x : scale[axis]?.(tickValue) + globalTransform.x,
        y: isVertical2 ? scale[axis]?.(tickValue) + globalTransform.y : gridOffset.y + globalTransform.y
      }
    };
    childProps[index2] = {
      axis: Object.assign({
...
var VictoryAxisBase = class extends import_react36.default.Component {
  ...
  static getDomain = axis_exports.getDomain;
  static getAxis = axis_exports.getAxis;
...
var VictoryBarBase = class _VictoryBarBase extends import_react38.default.Component {
  static animationWhitelist = ["data", "domain", "height", "padding", "style", "width"];
...
var VictoryBoxPlotBase = class extends import_react39.default.Component {
  ...
  static role = "boxplot";
  static defaultTransitions = default_transitions_exports.discreteTransitions();
  static defaultProps = {
...
var CanvasGroup = (props) => {
  ...
  const clip = import_react46.default.useCallback((ctx) => {
    const paddingRight = typeof padding3 === "number" ? padding3 : padding3?.right || 0;
    const paddingLeft = typeof padding3 === "number" ? padding3 : padding3?.left || 0;
...
var getStyleObject2 = (props) => {
  ...
  const mergeStyles = () => {
    const styleNamespaces = ["axis", "axisLabel", "grid", "parent", "tickLabels", "ticks"];
    return styleNamespaces.reduce((memo, curr) => {
      memo[curr] = (0, import_defaults29.default)({}, specificAxisStyle?.[curr], generalAxisStyle?.[curr]);
      return memo;
    }, {});
  };
  return generalAxisStyle && specificAxisStyle ? mergeStyles() : specificAxisStyle || generalAxisStyle;
...
var SelectionHelpersClass = class {
  ...
  onMouseMove = (0, import_throttle3.default)(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS, {
    leading: true,
    trailing: false
  });
  onMouseUp = (evt, targetProps) => {
...
var VictoryTooltip = class extends import_react58.default.Component {
  ...
  getEvaluatedProps(props) {
    ...
    const offsetX = (0, import_isPlainObject7.default)(centerOffset) && centerOffset?.x !== void 0 ? helpers_exports.evaluateProp(centerOffset.x, evaluatedProps) : 0;
    const offsetY = (0, import_isPlainObject7.default)(centerOffset) && centerOffset?.y !== void 0 ? helpers_exports.evaluateProp(centerOffset.y, evaluatedProps) : 0;
    return {
      ...evaluatedProps,
      centerOffset: {
        x: offsetX,
...
var VoronoiHelpersClass = class {
  ...
  onMouseMove = (0, import_throttle4.default)(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS2, {
    leading: true,
    trailing: false
  });
};
...
var CursorHelpersClass = class {
  ...
  onMouseMove = (0, import_throttle5.default)(this.handleMouseMove, ON_MOUSE_MOVE_THROTTLE_MS3, {
    leading: true,
    trailing: false
  });
...
var useVictoryCursorContainer = (initialProps) => {
  ...
  const getPadding3 = () => {
    if (props.padding === void 0) {
      ...
      return helpers_exports.getPadding(child?.props?.padding);
    }
...
var getDomain8 = (props, axis) => {
  ...
  return props.data?.length ? domain_exports.getDomainWithZero({
    ...props,
    data
  }, "y") : [0, 1];
};
...
var defaultData5 = [];
var VictoryHistogramBase = class _VictoryHistogramBase extends import_react67.default.Component {
  static animationWhitelist = ["data", "domain", "height", "padding", "style", "width"];
...
var VictoryLineBase = class _VictoryLineBase extends import_react70.default.Component {
  constructor(props) {
    super(props);
  }
  ...
  static getDomain = domain_exports.getDomain;
  static getData = data_exports.getData;
  static getBaseProps(props) {
...
var getCategoriesFromProps = (props) => Array.isArray(props.categories) ? props.categories : props?.categories?.x ?? [];
...
var getBaseProps13 = (initialProps, fallbackProps22) => {
  ...
  return data.reduce((childProps, datum, index2) => {
    const polygon = polygons[index2]?.filter((value) => value !== "data");
    const eventKey = !helpers_exports.isNil(datum.eventKey) ? datum.eventKey : index2;
    const {
      x: x3,
      y: y3
